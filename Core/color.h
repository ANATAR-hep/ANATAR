...
Symbol NA,NR,I2R;
Dimension NR;
AutoDeclare Index Colour=NR, iColour=NR;
Dimension NA;
AutoDeclare Index cOli,cOlj,cOlk,cOln;
AutoDeclare Index Gluon=NA, iGluon=NA;
...
set   Gluon:Gluon1,...,Gluon30;
set   Colour:Colour1,...,Colour30;
set   IntGluon:iGluon1,...,iGluon30;
set   IntColour:iColour1,...,iColour30;
ProperCount ON;
.global
*
*--#] Declarations : 
